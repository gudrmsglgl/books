...
- 핵심문제 찾기
  ...
  - 모든 일치 도구는 과제를 인간의 인지구조에 맞게 바꿔서 어려움을 감소
- '넛지 (Nudge)'
  - 강요에 의하지 않고 유연하게 개입함으로써 선택을 유도하는 행동조작 철학을 제안
  - 넛지를 유도하는 영리한 방법 중 하나 => 목록에서 항목들을 현명하게 배치 
    - 예) 카페에서 좋은 음식 앞에 배치, 디저트 간식은 뒤에 놓아서 쉽게 닿지 않게, 선거에서 번호 앞에 배치
- 행동을 조작하는 가장 강력한 도구 => '디폴트(default)'
  - 디폴트는 우리가 살고 있는 복잡한 세상에서의 상호작용을 효과적으로 간단하게 만들어 줌
- 좋은 메뉴얼보다 더 필요한 것은 메뉴얼이 필요 없는 시스템.

<br>

## 9장 즐거움을 디자인하라
- 디자이너는 복잡함이 바람직한 모습을 드러내도록 사용자에게 좋은 구조와 일관된 경험을 제공해야 한다.
- 제품의 우수성의 설명 초점 => 고객의 바람에 초점을 맞춰야 한다.
- 리뷰어의 편견
  - 리뷰어는 너무 많이 알고 있다는 것이 문제.
  - 평범한 고객들의 고민이 무엇인지 알지 못함.
  - '선택의 심리학'
    - 더 많은 선택권 => 만족도가 줄어든다.
    - 선택권의 제한 => 심픓함 => 만족도
- 불필요한 혼란스러움을 피하자
- 디자이너의 역할
  ...
  - 경제적인 측면 고려
  - 문화적, 교육적, 동기부여 측면도 고려
  - 최종 결과가 정확하게 의도한 대로 전달될 수 있게 설계
  - 인지 가능한 기표도 제공 (이전, 현재, 앞으로 상태 단계)